...
import { IEncryptoken } from "./IEncryptoken.sol";

error ErrorInsufficientFunds();
error ERC20InvalidApprover(address);
error ERC20InvalidSpender(address);

contract Encryptoken is IEncryptoken, ERC20, Permissioned {
    ...
    // ) virtual public view returns (euint32) {
    //     euint32 returnbal = _encBalances[account];
    //     return returnbal;
    // }
